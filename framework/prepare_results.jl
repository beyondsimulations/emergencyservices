...
# plot the results for each location
    ...
    ylims = (0, y_limit)))
    if save_plots == true
        savefig("graphs/location_dispatch_$problem.pdf")
    end
    ...
    ylims = (0, y_limit)))
    if save_plots == true
        savefig("graphs/location_driving_$problem.pdf")
    end
    ...
    ylims = (0, y_limit)))
    if save_plots == true
        savefig("graphs/location_incidents_$problem.pdf")
    end
    ...
    ylims = (0, 1)))
    if save_plots == true
        savefig("graphs/location_exchange_$problem.pdf")
    end
...
# plot the results for each priority
    ...
    ylims = (0, y_limit)))
    if save_plots == true
        savefig("graphs/priority_dispatch_$problem.pdf")
    end
    ...
    ylims = (0, y_limit)))
    if save_plots == true
        savefig("graphs/priority_driving_$problem.pdf")
    end
    ...
    ylims = (0, y_limit)))
    if save_plots == true
        savefig("graphs/priority_incidents_$problem.pdf")
    end
    ...
    ylims = (0, 1)))
    if save_plots == true
        savefig("graphs/priority_exchange_$problem.pdf")
    end
...
# plot the ressource flow during simulation
    ...
    if save_plots == true
        savefig("graphs/ressources_allocated_$problem.pdf")
    end
...
# plot the ressource allcoation of the heuristic
    ...
    display(@df capacity_status plot(:weekhour, :value, group = :variable,
                ...
                ylims = (y_limit_min, y_limit_max)))
    if save_plots == true
        savefig("graphs/ressources_status_$problem.pdf")
    end